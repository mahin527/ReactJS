function Card({title='Here is the title', btnText='Learn More'}) {
    // console.log(`Props: `, props);
    // console.log(title);
    
    return (
        <div className="mt-8 md:max-w-sm w-full p-6 rounded-xl shadow-xl bg-black border border-zinc-800 hover:border-white transition-all duration-300 hover:transform hover:scale-105 group">
